      ...
      <div className="flex justify-between items-center px-20">
        ...
        <div className="flex gap-5">
          <DropdownMenu>
            ...
            <DropdownMenuContent className="flex flex-col gap-2 cursor-pointer border-[1px] px-4 rounded-md ">
      ...
      <div className="flex justify-center">
        ...
        >
          <CarouselContent className="w-[1200px] ">
            ...
            <CarouselItem>
              <img
                src="https://cdn.apollo.audio/one/media/66f1/6ce2/ea12/2905/a801/7a02/gladiator-2.jpg?quality=80&format=jpg&crop=0,0,843,1500&resize=crop"
                alt=""
              />
            </CarouselItem>
            <CarouselItem>
              <img
                src="https://thefeaturepresentation.com/wp-content/uploads/2024/05/13kbYnQRIRRijKHdGbtTSWw.jpg"
                alt=""
              />
            </CarouselItem>
          </CarouselContent>
