...
export const UpcomingMovies: Movietype[] = [
  ...
  {
    name: "Solo Leveling: ReAwaikening",
    rating: 6,
    images: ["/solo.jpg"],
  },
  {
...
export const TopRatedMovies: Movietype[] = [
  {
    name: "Pulp Fiction",
    rating: 9.3,
    images: ["/pulp.jpg"],
  ...
  {
    name: "The Good, the Bad and Ugly",
    rating: 8.4,
    images: ["/goodbad.png"],
  },
  {
